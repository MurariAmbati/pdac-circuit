# Methods, complete record

**Research Use Only.** No clinical, diagnostic, therapeutic, or wet-lab efficacy claim.
...
found in the pipeline. Summary of outcomes: [FINDINGS.md](FINDINGS.md). Result tables:
