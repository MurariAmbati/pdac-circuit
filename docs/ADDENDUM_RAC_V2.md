...
**Research Use Only.** This addendum documents an attempt to *rebuild* the Regulatory Attractor
Control method after [ADDENDUM_DYNAMICS.md](ADDENDUM_DYNAMICS.md) §7 concluded that its failure is
