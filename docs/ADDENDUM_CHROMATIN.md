...
retired, shown unrescuable, or caught out as confounded, which the [dynamics addendum](ADDENDUM_DYNAMICS.md),
the [attractor-model rebuild](ADDENDUM_RAC_V2.md) and the [review arc](../REVIEW_RESPONSE.md) cover.
