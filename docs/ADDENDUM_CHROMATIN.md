# Addendum — The one surviving result: PDAC-gained promoter H3K27ac at RAC-surfaced loci

**Research Use Only.** This addendum consolidates the single claim in this project that survived the
...
shown unrescuable, or exposed as confounded — see [ADDENDUM_DYNAMICS.md](ADDENDUM_DYNAMICS.md),
[ADDENDUM_RAC_V2.md](ADDENDUM_RAC_V2.md) and [../REVIEW_RESPONSE.md](../REVIEW_RESPONSE.md).
