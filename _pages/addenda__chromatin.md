...
[dynamics addendum]({{ '/addenda/dynamics/' | relative_url }}), the [attractor-model rebuild]({{ '/addenda/rac-v2/' | relative_url }}) and the
[review arc]({{ '/reports/review/' | relative_url }}). Sections §25–§28 of the review response are the primary
